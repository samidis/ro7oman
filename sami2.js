...
#users .uzr.stl2 .u-msg {
  ...
  background-image: url(https://up6.cc/2023/05/168460972948671.gif);
...
var me_user1=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('سامي ديزاين')").addClass('stl2');
        $("#users .uzr.stl2 .c-flex.fr").append('<img class="My_star1" src="https://up6.cc/2023/05/168460957171522.gif">');
	$("#users .uzr.stl2 .c-flex.fr").append('<img class="My_tsor" src="https://up6.cc/2023/05/168460957169821.png">');
	$("#users .uzr.stl2 .c-flex.fr").after('<div id="my_mood1" class="label label-primary" style=" margin-bottom: 1px; display: inline-block;width: 100%;margin-top: 10px;height: 22px;cursor: pointer;border-radius: 50px;padding: 0px;background-image: linear-gradient(-225deg, #000 0%, #000 29%, #660404 67%, #000 100%);" href="https://www.ro7oman.com/">مصمم بنرات</div>');
