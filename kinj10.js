...
#users .uzr.kinj img.co {
  transform: rotate(90deg);
  margin-top: -60px !important;
  margin-right: 340px;
}

#users .uzr.kinj span.uhash{
    margin-right: 350px;
  margin-top: 24px;
  margin-left: 0px;}


#users .uzr.kinj img.u-ico {
    margin-left: 2px;
...
#users .uzr.kinj .d-flex.fl {
  padding-right: 0px !important;
}

#users .uzr.kinj .u-topic {

  margin-left: 0px;
}

#users .uzr.kinj .kinj_star1 {
 width: 132px;
height: 89px;
margin-top: -53px;
cursor: pointer;
...
var l_itvkinj=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('♪.شَغـ.ــف')").addClass('kinj1');
        $("#users .uzr.kinj1 .fitimg.u-pic").append('<img class="kinj_star1" src="https://up6.cc/2023/06/168675701315521.png">');
		$("#users .uzr.kinj1 span.u-topic").after('<img id="mystory1" class="My_vedio1" title="ستوري" style="float: right;width: 20px;margin-top: 0px;margin-right: 5px;cursor: pointer;" src="https://up6.cc/2023/05/168535361230321.gif">');
